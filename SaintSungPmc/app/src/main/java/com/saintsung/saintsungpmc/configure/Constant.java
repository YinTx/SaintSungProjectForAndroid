...
public class Constant {
    ...
    //旧版小掌机UUID
//    public static final UUID uuidService = UUID.fromString("00001910-0000-1000-8000-00805f9b34fb");
...
//    public static String uuidNotify="0000ffe1-0000-1000-8000-00805f9b34fb";
    ...
    public static final String addressHttps="http://47.98.187.248/index.php/";
}
